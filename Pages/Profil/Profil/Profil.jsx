        ...
        <>
            <ScrollView contentContainerStyle={[theme[mode].container, styles.content]}>
                ...
                <View style={theme[mode].inputGroupDisable}>
                    ...
                    <TextInput style={theme[mode].inputGroup.input} editable={false} defaultValue={"Antoine"}/>
                </View>
                <View style={theme[mode].inputGroupDisable}>
                    <Text style={theme[mode].inputGroup.label}>Nom</Text>
                    <TextInput style={theme[mode].inputGroup.input} editable={false} defaultValue={"Gaudry"}/>
                </View>
                <View style={theme[mode].inputGroupDisable}>
                    <Text style={theme[mode].inputGroup.label}>Email</Text>
                    <TextInput style={theme[mode].inputGroup.input} editable={false} defaultValue={"Antoine.gaudry@email.com"}/>
                </View>
                <View style={theme[mode].inputGroupDisable}>
                    <Text style={theme[mode].inputGroup.label}>Identifiant</Text>
                    <TextInput style={theme[mode].inputGroup.input} editable={false} defaultValue={"Jepeta"}/>
                </View>
                <View style={theme[mode].inputGroupDisable}>
                    <Text style={theme[mode].inputGroup.label}>Mot de passe</Text>
                    <TextInput style={[theme[mode].inputGroup.input, styles.password]} editable={false} secureTextEntry defaultValue={"Antoine2001"}/>
                </View>
